export default function Home() {
  return (
    <main className="flex min-h-screen flex-col items-center justify-center p-24 overflow-hidden max-w-6xl mx-auto w-full">
      ...
      <div className="flex flex-col lg:flex-row gap-4 mb-4 w-full h-full">
        <div className="flex flex-col flex-1 h-full">
          <textarea
            className="resize-none p-4 h-full overflow-auto border rounded-md w-full"
            placeholder="Enter text to translate..."
            style={{ height: "calc(100% - 2rem)" }} // Adjusting height to make the textarea as tall as possible, accounting for the paragraph's margin
          ></textarea>
